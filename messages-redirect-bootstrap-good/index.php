...
<div class="content">
    ...
    <div style="display: flex;align-items: center;" class="hidden" id="help">
        ...
        <div style="padding: 8px;">
            <ol>
                <li>New messageで新しいメッセージを作成します。Editへメッセージの編集。Deleteでメッセージを削除できます。
                </li>
                <li>
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <turbo-frame id="edit-modal" target="_top">
                </turbo-frame>
            </div>
        </div>
    </div>
